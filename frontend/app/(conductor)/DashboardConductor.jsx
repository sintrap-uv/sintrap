  ...
  const cambiarEstadoTurno = async (nuevoEstado) => {
    ...
    try {
      ...
      if (resultado.success) {
        ...
        showSuccess(`Turno cambió a ${nombreTurno(nuevoEstado)}`);
...
const styles = StyleSheet.create({
  ...
  porcentajeTexto: { fontSize: 11, fontWeight: "600" },
  ...
  badgeActual: { backgroundColor: "#FEF3C7", borderRadius: 6, paddingVertical: 2, paddingHorizontal: 8 },
  ...
  estadoOptionActive: { backgroundColor: "#F0FDF4", borderLeftColor: "#22C55E" },
